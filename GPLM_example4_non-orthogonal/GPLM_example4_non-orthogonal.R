...
#######################################################
#logistic partial linear cos example 4
# cos a=1.5 n=200 
set.seed(20121003)

#a=1.5 n=100 set.seed(20150208)
#cos a=1 n=200    set.seed(20121024)
#cos a=1 n=100  set.seed(201502977)
#cos a=0.5 n=100 set.seed(201502077)
#cos a=0.5 n=200   set.seed(20121019)
