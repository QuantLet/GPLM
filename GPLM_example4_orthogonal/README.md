...
## [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **GPLM_example4_orthogonal** [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/)
...
Description : 'Computes the percent of rejection in example 4 when z1 and z2 are orthogonal to x
...
Example : 'x is random and uniform on [-0.5,1], z1 and z2 are orthogonal to x, a=0.5, 1, 1.5,
sample size 200'
